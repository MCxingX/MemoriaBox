...
class EventRepository(private val eventDao: EventDao) {
    ...
    suspend fun getEventsByBoxIdOnce(boxId: String): List<Event> = eventDao.getEventsByBoxIdOnce(boxId)
    suspend fun getTodoEventsOnce(): List<Event> = eventDao.getTodoEventsOnce()
    suspend fun getBirthdayEventByAvatarUri(avatarUri: String): Event? = eventDao.getBirthdayEventByAvatarUri(avatarUri)
...
class LabelRepository(private val labelDao: LabelDao) {
    ...
    suspend fun getEventLabelsOnce(eventId: String): List<String> = labelDao.getEventLabelsOnce(eventId)
